  ...
  return (
    <div className="register min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 rounded-xl bg-gray-50 shadow-md px-8 py-12">
        <h1 className="text-2xl text-center font-semibold text-gray-800">Register</h1>
...
<input type="password" id="confirmPassword" name="confirmPassword" className="w-full rounded-md px-3 py-2 border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500" value={formData.confirmPassword} onChange={handleChange} required />
</div>
    ...
    <div className="login-reminder  flex items-center justify-between ">
          ...
          <p className="mt-2 text-1xl text-gray-600 text-center pr-16">Already have an account.</p>
        </div>
  </div>
</div>
);
